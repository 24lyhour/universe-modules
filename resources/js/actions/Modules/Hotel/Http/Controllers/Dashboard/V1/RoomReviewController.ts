...
/**
* @see \Modules\Hotel\Http\Controllers\Dashboard\V1\RoomReviewController::index
* @see Modules/Hotel/app/Http/Controllers/Dashboard/V1/RoomReviewController.php:19
* @route '/dashboard/hotel-room-reviews'
*/
...
index.definition = {
    methods: ["get","head"],
    url: '/dashboard/hotel-room-reviews',
...
/**
* @see \Modules\Hotel\Http\Controllers\Dashboard\V1\RoomReviewController::trash
* @see Modules/Hotel/app/Http/Controllers/Dashboard/V1/RoomReviewController.php:78
* @route '/dashboard/hotel-room-reviews/trash'
*/
...
trash.definition = {
    methods: ["get","head"],
    url: '/dashboard/hotel-room-reviews/trash',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \Modules\Hotel\Http\Controllers\Dashboard\V1\RoomReviewController::show
* @see Modules/Hotel/app/Http/Controllers/Dashboard/V1/RoomReviewController.php:27
* @route '/dashboard/hotel-room-reviews/{review}'
*/
...
show.definition = {
    methods: ["get","head"],
    url: '/dashboard/hotel-room-reviews/{review}',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \Modules\Hotel\Http\Controllers\Dashboard\V1\RoomReviewController::confirmDelete
* @see Modules/Hotel/app/Http/Controllers/Dashboard/V1/RoomReviewController.php:58
* @route '/dashboard/hotel-room-reviews/{review}/delete'
*/
...
confirmDelete.definition = {
    methods: ["get","head"],
    url: '/dashboard/hotel-room-reviews/{review}/delete',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \Modules\Hotel\Http\Controllers\Dashboard\V1\RoomReviewController::toggleActive
* @see Modules/Hotel/app/Http/Controllers/Dashboard/V1/RoomReviewController.php:47
* @route '/dashboard/hotel-room-reviews/{review}/status'
*/
export const toggleActive = (args: { review: string | number | { uuid: string | number } } | [review: string | number | { uuid: string | number } ] | string | number | { uuid: string | number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
...
toggleActive.definition = {
    methods: ["patch"],
    url: '/dashboard/hotel-room-reviews/{review}/status',
...
* @route '/dashboard/hotel-room-reviews/{review}/status'
*/
toggleActive.url = (args: { review: string | number | { uuid: string | number } } | [review: string | number | { uuid: string | number } ] | string | number | { uuid: string | number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { review: args }
    }
...
* @route '/dashboard/hotel-room-reviews/{review}/status'
*/
toggleActive.patch = (args: { review: string | number | { uuid: string | number } } | [review: string | number | { uuid: string | number } ] | string | number | { uuid: string | number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: toggleActive.url(args, options),
    method: 'patch',
})
...
* @route '/dashboard/hotel-room-reviews/{review}/status'
*/
const toggleActiveForm = (args: { review: string | number | { uuid: string | number } } | [review: string | number | { uuid: string | number } ] | string | number | { uuid: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/dashboard/hotel-room-reviews/{review}/status'
*/
toggleActiveForm.patch = (args: { review: string | number | { uuid: string | number } } | [review: string | number | { uuid: string | number } ] | string | number | { uuid: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: toggleActive.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'PATCH',
            ...(options?.query ?? options?.mergeQuery ?? {}),
...
/**
* @see \Modules\Hotel\Http\Controllers\Dashboard\V1\RoomReviewController::reply
* @see Modules/Hotel/app/Http/Controllers/Dashboard/V1/RoomReviewController.php:36
* @route '/dashboard/hotel-room-reviews/{review}/reply'
*/
...
reply.definition = {
    methods: ["patch"],
    url: '/dashboard/hotel-room-reviews/{review}/reply',
} satisfies RouteDefinition<["patch"]>
...
/**
* @see \Modules\Hotel\Http\Controllers\Dashboard\V1\RoomReviewController::destroy
* @see Modules/Hotel/app/Http/Controllers/Dashboard/V1/RoomReviewController.php:67
* @route '/dashboard/hotel-room-reviews/{review}'
*/
...
/**
* @see \Modules\Hotel\Http\Controllers\Dashboard\V1\RoomReviewController::restore
* @see Modules/Hotel/app/Http/Controllers/Dashboard/V1/RoomReviewController.php:87
* @route '/dashboard/hotel-room-reviews/{uuid}/restore'
*/
...
restore.definition = {
    methods: ["put"],
    url: '/dashboard/hotel-room-reviews/{uuid}/restore',
...
/**
* @see \Modules\Hotel\Http\Controllers\Dashboard\V1\RoomReviewController::forceDelete
* @see Modules/Hotel/app/Http/Controllers/Dashboard/V1/RoomReviewController.php:95
* @route '/dashboard/hotel-room-reviews/{uuid}/force-delete'
*/
...
forceDelete.definition = {
    methods: ["delete"],
    url: '/dashboard/hotel-room-reviews/{uuid}/force-delete',
} satisfies RouteDefinition<["delete"]>
...
const RoomReviewController = { index, trash, show, confirmDelete, toggleActive, reply, destroy, restore, forceDelete }
