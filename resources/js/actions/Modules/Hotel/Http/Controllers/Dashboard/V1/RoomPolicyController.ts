...
const RoomPolicyController = { trash, restore, forceDelete, bulkDelete, toggleActive, confirmDelete, index, create, store, edit, update, destroy }

export default RoomPolicyController