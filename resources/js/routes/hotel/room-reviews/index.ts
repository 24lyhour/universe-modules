...
/**
* @see \Modules\Hotel\Http\Controllers\Dashboard\V1\RoomReviewController::updateStatus
...
*/
export const updateStatus = (args: { review: string | number | { uuid: string | number } } | [review: string | number | { uuid: string | number } ] | string | number | { uuid: string | number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
...
* @route '/dashboard/hotel-room-reviews/{review}/status'
*/
updateStatus.url = (args: { review: string | number | { uuid: string | number } } | [review: string | number | { uuid: string | number } ] | string | number | { uuid: string | number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { review: args }
    }
...
* @route '/dashboard/hotel-room-reviews/{review}/status'
*/
updateStatus.patch = (args: { review: string | number | { uuid: string | number } } | [review: string | number | { uuid: string | number } ] | string | number | { uuid: string | number }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: updateStatus.url(args, options),
    method: 'patch',
})
...
* @route '/dashboard/hotel-room-reviews/{review}/status'
*/
const updateStatusForm = (args: { review: string | number | { uuid: string | number } } | [review: string | number | { uuid: string | number } ] | string | number | { uuid: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/dashboard/hotel-room-reviews/{review}/status'
*/
updateStatusForm.patch = (args: { review: string | number | { uuid: string | number } } | [review: string | number | { uuid: string | number } ] | string | number | { uuid: string | number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: updateStatus.url(args, {
        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
            _method: 'PATCH',
            ...(options?.query ?? options?.mergeQuery ?? {}),
